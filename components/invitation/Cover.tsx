  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-3 sm:inset-5 z-0 rounded-3xl border-2 border-[#C5A059]/40 bg-[#FAF5EB]/90 shadow-2xl backdrop-blur-sm pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-12 left-10 w-2 h-2 rounded-full bg-[#D4AF37]/60 animate-float-particle" />
        <div className="absolute top-24 right-12 w-3 h-3 rounded-full bg-[#D4AF37]/40 animate-float-particle" style={{ animationDelay: "1.5s" }} />
        <div className="absolute bottom-20 left-14 w-2.5 h-2.5 rounded-full bg-[#D4AF37]/50 animate-float-particle" style={{ animationDelay: "0.8s" }} />
        <div className="absolute bottom-16 right-10 w-2 h-2 rounded-full bg-[#D4AF37]/60 animate-float-particle" style={{ animationDelay: "2.2s" }} />
      </div>
      ...
      {/* Center Featured Gunungan Wayang */}
      <motion.div
      ...
      >
        ...
        <motion.div 
          ...
          className="pt-1 space-y-0.5 text-[#3E2211]"
        >
        ...
        <motion.button
          ...
          onClick={onOpen}
          className="btn-jawa-gold py-3 px-8 rounded-full inline-flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold shadow-xl cursor-pointer mt-3"
        >
          <Mail className="w-4 h-4 animate-bounce text-[#F3E5AB]" />
